...
import { logoutUserAPI, updatedUserAPI } from '~/redux/user/userSlice';
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      ...
      .then(() => {
        ...
        toast
          .promise(
            dispatch(updatedUserAPI({ current_password, new_password })),
            {
          ...
          .then((res) => {
            // Xử lý sau khi đổi mật khẩu thành công, ví dụ: redirect đến trang đăng nhập
            if (!res.error) {
