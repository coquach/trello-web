...
export const moveCardToDifferentColumnAPI = async (updateData) => {
    const response = await authorizedAxiosInstance.put(`${API_ROOT}/v1/boards/support/moving_card`, updateData)
    return response.data
}
...
export const verifyUserAPI = async (data) => {
    ...
    toast.success('Account verified successfully! Now you can login to enjoy your services! Have a good day!')
    return response.data
}
